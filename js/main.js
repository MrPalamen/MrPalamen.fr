...
(function($) {
    ...
    function initCountdownPlugin() {
        var propertyString = eval('(' + $('#timer').data("property") + ')');
        var untilDate = new Date(propertyString.until);

        if (isNaN(untilDate.getTime())) {
            console.error('Invalid date');
            untilDate = new Date();
        }
        $('#timer').countdown({until: untilDate});
    }
